    ...
    <div>
      ...
      <Container className="relative px-2 md:px-6 py-12 md:py-24 space-y-8">
        <div className="max-w-xl mx-auto">
          <Heading title={<>The technology you need, without the limitations that hold you back</>} as="p" size="medium" variant="body" className="text-center" />
        </div>
      ...
      <Container className="relative px-2 md:px-6 py-12 md:py-24 space-y-8">
        <div className="max-w-2xl">
          <Heading title={<>Three services to make technology work for you</>} as="p" size="medium" variant="body" className="" hasSlash />
        </div>
